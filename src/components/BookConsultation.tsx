...
export default function BookConsultation() {
  ...
  return (
    <section id="book-consultation" className="py-16 bg-purple-50">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              <div className="bg-white p-8 rounded-lg shadow-md">
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-purple-700 text-white font-medium py-3 rounded-md hover:bg-purple-800 transition duration-300"
                  >
                    Submit
                  </button>
                </form>
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="bg-purple-100 p-6 rounded-lg border-l-4 border-purple-700">
                <h3 className="text-xl font-semibold text-purple-900 mb-2">Why Choose Us?</h3>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-purple-700 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
